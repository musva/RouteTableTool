...
namespace CodeCowboy.NetworkRoute
{
    public class NicInterface
    {
        ...
        public static void PrintAllNetworkInterface()
        {
            ...
            Debug.WriteLine("{0,18} {1,18} {2,18} {3,20} {4,6} {5}", "IP Address", "Subnet Mask", "Gateway", "MAC", "IF", "Name");
            foreach (NetworkAdaptor na in naList)
            {
                Debug.WriteLine("{0,18} {1,18} {2,18} {3,20} {4,6} {5}", na.PrimaryIpAddress, na.SubnetMask, na.PrimaryGateway, na.MACAddress, na.InterfaceIndex, na.Name);
            }
        }
